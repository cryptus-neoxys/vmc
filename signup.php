...
<body>
    ...
    <div class="login-wrapper">
        ...
        <form class="login-form" algin="center" method="post" action="signup_form.php">
            ...
            <input required name="aadharNumber" pattern="^[0-9]{12}$" title="12 digit Aadhar number" id="aadharNumber" style="margin-bottom:20px; width:350px; padding: 10px;" type="text" />
            ...
            <input required name="wardNumber" id="wardNumber" style="margin-bottom:20px; width:350px; padding: 10px;" type="number" min="1" max="4" />
